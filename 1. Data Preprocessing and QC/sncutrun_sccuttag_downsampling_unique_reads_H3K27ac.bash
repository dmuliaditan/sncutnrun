...
#SBATCH -J after_downsampling_snCUTRUN_calculate_mapping_rate_H3K27ac
#SBATCH -t 24:00:00
#SBATCH -N 1
#SBATCH -p normal
...
touch 'after_downsampling_snCUTRUN_H3K27ac_mapping_metrics.txt'
...
cat "$i"'_barcodes_precount_downsampled.txt' >> 'after_downsampling_snCUTRUN_H3K27ac_mapping_metrics.txt'
